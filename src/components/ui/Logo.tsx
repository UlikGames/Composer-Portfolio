...
/**
 * Logo component with classical treble clef icon
 * 
 * @example
...
export const Logo = ({
  ...
  // Treble clef is taller than wide, so we adjust the height
  const aspectRatio = 153.12 / 95.116; // height / width from original viewBox
  ...
  return (
    ...
    >
      {/* Classical Treble Clef (G Clef) - Proper Design */}
      <path
